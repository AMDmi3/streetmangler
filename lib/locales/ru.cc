...
StatusPartData status_parts[] = {
	...
	{ "район",      NULL, NULL,    { "район", "р-н",                       NULL } },
	{ "микрорайон", NULL, NULL,    { "микрорайон", "мкр-н", "мк-н", "мкр", "мкрн", NULL } },
	{ "посёлок",    NULL, NULL,    { "посёлок", "поселок", "пос",          NULL } },
	{ "деревня",    NULL, NULL,    { "деревня", "дер", "д",                NULL } },
	{ "квартал",    NULL, NULL,    { "квартал", "кв-л",                    NULL } },
